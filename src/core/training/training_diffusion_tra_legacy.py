...
from src.core.training.trainer_diffusion import TrainerDiffusion, TesterDiffusion
...
if __name__ == "__main__":
    ...
    ### ACDM_ncn
    # modelName = "2D_Tra/128_acdm-r20_ncn"
    # p_d = DataParams(batch=64, augmentations=["normalize"], sequenceLength=[3,2], randSeqOffset=True,
    #             dataSize=[128,64], dimension=2, simFields=["dens","pres"], simParams=["mach"], normalizeMode="machMixed")
    # p_t = TrainingParams(epochs=3100, lr=0.0001)
    # p_l = LossParams()
    ...
    # modelName = "2D_Tra/128_refiner-r4_std0.000001"
